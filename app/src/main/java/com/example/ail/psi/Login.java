...
public class Login extends AppCompatActivity {
    ...
    Button btn_register, btn_login, btn_forgetpassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_forgetpassword  = (Button) findViewById(R.id.btn_forgotpasword);
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // mengecek kolom yang kosongo
                if (username.trim().length() == 0 ){
                    txt_username.setError("Kolom Tidak boleh kosong");
                }else if(password.trim().length() == 0 ) {
                    txt_password.setError("Kolom Tidak Boleh Kosong");
